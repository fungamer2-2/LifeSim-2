    ...
    def createEvent(self, x):
        ...
        if pinput == "1":
            if self.eventType == "Family_Event":
                x.relationships[0].relationshipvalue += self.optionOneResult
                x.relationships[1].relationshipvalue += self.optionOneResult
        ...
        if pinput == "2":
            if self.eventType == "Family_Event":
                x.relationships[0].relationshipvalue -= self.optionTwoResult
                x.relationships[1].relationshipvalue -= self.optionTwoResult
